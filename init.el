...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ivy-erlang-complete company-erlang gnu-elpa-keyring-update erlang yasnippet-snippets cargo flycheck-rust hindent benchmark-init dockerfile-mode elisp-mode go-flycheck company-yasnippet unicad uniquify linum-highlight-current-line-number x86-lookup docker-compose-mode ob-go org htmlize go-impl company-go yaml-mode helm-go-package sr-speedbar go-eldoc go-snippets syslog-mode auto-save-buffers-enhanced helm-projectile go-guru company go-mode spice-mode indent-guide graphviz-dot-mode rainbow-delimiters unicode-fonts highlight-indent-guides helm-flycheck flycheck markdown-mode helm use-package paredit systemtap-mode highlight-current-line window-numbering tabbar relative-line-numbers buttercup)))

(add-to-list 'load-path
			 (car (file-expand-wildcards "/usr/lib/erlang/lib/tools-3.0.2/emacs")))
...
(use-package erlang
  ...
  (ivy-erlang-complete-erlang-root "/usr/lib/erlang/")
  :config
  ...
  (defun hook-fun ()
	...
	(setq ivy-erlang-complete-erlang-root "/usr/lib/erlang/")
	(company-erlang-init)
