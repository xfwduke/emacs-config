;;; -*- no-byte-compile: t -*-
(define-package "company-distel" "20180827.1344" "Erlang/distel completion backend for company-mode" '((distel-completion-lib "1.0.0")) :commit "acc4c0a5521904203d797fe96b08e5fae4233c7e" :keywords '("erlang" "distel" "company") :authors '(("Sebastian Weddmark Olsson")) :maintainer '("Sebastian Weddmark Olsson") :url "github.com/sebastiw/distel-completion")
